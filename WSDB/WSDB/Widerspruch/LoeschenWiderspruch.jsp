...
#Step4Hilfeempfänger
{
	position:absolute;
	font-size:11px;
<logic:match name="wsForm" property="vertreterVorhanden" value="true">
width:48%;
</logic:match>
<logic:match name="wsForm" property="vertreterVorhanden" value="false">
width:100%;
</logic:match>
	height:48%;
	left: 0px;
...
<html:form action="LoeschenWiderspruch" target="main">
<div id="Aussenlayer">
  <div id="Innenlayer">
	<div id="Kopfzeile">Widerspruch löschen </div>
	<!--==================== Formular ====================-->
	<div id="Formular">
		...
		<LEGEND ALIGN="left">Hilfeempfänger</LEGEND>
			<table width="100%"  border="0" cellspacing="0" cellpadding="0">
			  <tr>
				...
				<td width="2%">&nbsp;<html:hidden property="id" /></td>
				<td width="68%">
...
<!--==================== Beginn Vertreter ====================-->
		...
		<fieldset>
		<LEGEND ALIGN="left"><bean:write name="wsForm" property="vertreter.bezeichnung"/></LEGEND>
			<table width="100%"  border="0" cellspacing="0" cellpadding="0">
			  <tr>
				<td width="30%"><div align="right">Art:</div></td>
				<td width="2%"><div align="center"></div></td>
				<td width="68%">
				<html:select  name="wsForm" property="vertreter.art" size="1">
		...
		<LEGEND ALIGN="left">weitere Angaben zum Widerspruch</LEGEND>
			<table width="100%"  border="0" cellspacing="0" cellpadding="0">
			  ...
			  <tr>
				...
				<td width="2%"><div align="center">*</div></td>
				<td width="68%">
				<html:select name="wsForm" property="verfahrensartID" size="1" titleKey="label.Verfahrensart.title">
					<html:option value="">bitte auswählen:</html:option>
			  ...
			  <tr>
				...
				<td width="2%"><div align="center">*</div></td>
				<td width="68%">
				<html:select name="wsForm" property="gegenstandDesVerfahrensID" size="1" titleKey="label.GegenstandDesVerfahrens.title">
			  ...
			  <tr>
				...
				<td width="2%"><div align="center">*</div></td>
				<td width="68%">
				<html:select name="wsForm" property="rechtsgebietID" size="1" titleKey="label.Anrede.title">
	...
	<fieldset class="buttons">
		<table width="100%"  border="0" cellspacing="0" cellpadding="0">
		  <tr>
			...
			<td width="50%"><div align="right"><html:submit value="löschen >>" styleClass="button"/></div></td>
		  </tr>
		</table>
	</fieldset>	
	<!--==================== Buttons ====================-->			
