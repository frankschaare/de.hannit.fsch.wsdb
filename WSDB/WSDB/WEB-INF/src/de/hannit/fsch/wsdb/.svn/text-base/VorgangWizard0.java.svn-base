 ...
 * @author fsch
 *
 * Diese Klasse wird aufgerufen, wenn ein neuer Wide rspruch erfasst werden soll
 ...
 * 
 */
public class VorgangWizard0 extends Action 
{
	...
	session.setAttribute("vorgang", new Vorgang());
	FormularBean fb = Java2SQLMapper.getFormularbeanForTeams(req);
