...
<div id="Aussenlayer">
  <div id="Innenlayer">
	<div id="Kopfzeile">Fehler bei der Anmeldung !</div>
	<!--==================== Formular ====================-->
	<div id="Formular">
	<!--==================== Hinweise ====================-->	
		<fieldset>
			...
			<p>Ihre Anmeldung ist leider fehlgeschlagen. Dafür kann es folgende Ursachen geben:
			<ul>
			<li>Ihr Benutzername und/oder Passwort war falsch geschrieben</li>
			<li>Sie haben kein Zugriffsrecht für die Anwendung</li>
			<li>Die Anwendung steht zur Zeit nicht zur Verf&uuml;gung. </li>
			</ul>
			</p>
			<p>Bitte probieren Sie zunächst, sich erneut anzumelden. Falls das wiederum nicht klappt, wenden Sie sich bitte an Ihren TUI oder an die HannIT Hotline. </p>
	...
	<!--==================== Hinweise ====================-->	
		<fieldset>
		<LEGEND ALIGN="left">Erneute Anmeldung</LEGEND>
