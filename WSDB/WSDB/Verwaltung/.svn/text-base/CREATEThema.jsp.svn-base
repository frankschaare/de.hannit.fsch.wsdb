...
<html:form action="CREATEThema?crud=1" method="post" target="_self">
<div id="Aussenlayer">
  <div id="Innenlayer">
	<div id="Kopfzeile">Gegenstand des Verfahrens erfassen:</div>
	<!--==================== Formular ====================-->
	...
	<!--==================== Berechtigung hinzufügen ====================-->
		<span id="BerechtigungenNeu" style="width:98%;height:35%;">
			<fieldset>
				...
				<p style="padding-left:7px;"><bean:message key="Thema.insert.text.Hinweise"/></p>
		</fieldset>
		</span>
	<!--==================== Buttons ====================-->	
		<span id="Buttons">
