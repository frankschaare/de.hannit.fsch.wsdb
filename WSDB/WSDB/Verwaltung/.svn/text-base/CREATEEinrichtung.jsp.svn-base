...
<html:form action="CREATEEinrichtung?crud=1" method="post" target="_self">
<div id="Aussenlayer">
  <div id="Innenlayer">
	<div id="Kopfzeile">Neue Einrichtung erfassen:</div>
	<!--==================== Formular ====================-->
...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
	  ...
	  <tr>
		<td colspan="3"><div class="errors" align="center"><html:errors property="name"/></div></td>
		<td colspan="3"><div align="center"></div></td>
	  </tr>	 
	  <tr>
	  ...
	  <tr>
		<td colspan="3"><div class="errors" align="center"><html:errors property="adresse.postleitzahl"/></div></td>
		<td colspan="3"><div class="errors" align="center"><html:errors property="adresse.ort"/></div></td>
	  </tr>		   
	</table>
</fieldset>
		</span>
	...
	<!--==================== Berechtigung hinzufügen ====================-->
		<span id="BerechtigungenNeu" style="width:98%;height:35%;">
			<fieldset>
				...
				<p style="padding-left:7px;"><bean:message key="Einrichtung.insert.text.Hinweise"/></p>
		</fieldset>
		</span>
	<!--==================== Buttons ====================-->	
		<span id="Buttons">
