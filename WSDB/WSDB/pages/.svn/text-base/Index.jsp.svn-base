...
<!--jsp:useBean id="lb" scope="session" class="beans.LoginBean"/-->
...
<frameset cols="*,1014,*" frameborder="no" border="0" framespacing="0">
  	<frame src="../html/leer.htm" name="leftFrame" scrolling="NO" noresize>
  	<frame src="InnererFrame.jsp" name="mainFrame" scrolling="NO" noresize>
	<frame src="../html/leer.htm" name="rightFrame" scrolling="NO" noresize>
</frameset>
